...
function IconSun({className}: IIcon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
function IconMoon({className}: IIcon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
function IconPlus({className}: IIcon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="11"
...
export {IconArrowDown, IconArrowRight, IconArrowLeft, IconCalendar, IconSun, IconMoon, IconPlus}